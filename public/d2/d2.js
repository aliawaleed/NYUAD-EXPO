...
function generateOrder(){
    ...
    order.innerHTML = orderAppetizer + ', ' + orderMainCourse + ', ' + orderDessert;
}
...
function addAnswer(img) {
    ...
    // get the name of the item that the user has pressed within each category and store in variable;
